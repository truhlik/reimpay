...
class AdminGetTestCase(BaseViewPermissionTestCase):

    def setUp(self) -> None:
        super(AdminGetTestCase, self).setUp()
    ...
    def test_get_draft(self):
        ...
        self.assertEqual(200, self.client.get(reverse('visititem-detail', args=(self.visit_item.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('visit-detail', args=(self.visit1.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('patient-detail', args=(self.patient1.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('site-detail', args=(self.site1.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('arm-detail', args=(self.arm1.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('studyitem-detail', args=(self.study_item1.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('study-detail', args=(self.study1.id, ))).status_code)
    ...
    def test_get_prelaunch(self):
        ...
        self.assertEqual(405, self.client.get(reverse('patientvisititem-detail', args=(self.pvi.id,))).status_code)
        # self.assertEqual(403, self.client.get(reverse('patientvisit-detail', args=(self.patient_visit.id, )), data=self.patient_visit_data).status_code)
        self.assertEqual(200, self.client.get(reverse('visititem-detail', args=(self.visit_item.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('visit-detail', args=(self.visit1.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('patient-detail', args=(self.patient1.id,))).status_code)
        self.assertEqual(200, self.client.get(reverse('site-detail', args=(self.site1.id,))).status_code)
