...
class AdminDeleteTestCase(BaseViewPermissionTestCase):

    def setUp(self) -> None:
        super(AdminDeleteTestCase, self).setUp()
    ...
    def test_delete_draft(self):
        ...
        self.assertEqual(204, self.client.delete(reverse('visititem-detail', args=(self.visit_item.id,))).status_code)
        self.assertEqual(204, self.client.delete(reverse('visit-detail', args=(self.visit1.id,))).status_code)
        self.assertEqual(405, self.client.delete(reverse('patient-detail', args=(self.patient1.id,))).status_code)
        self.assertEqual(204, self.client.delete(reverse('site-detail', args=(self.site1.id,))).status_code)
        self.assertEqual(204, self.client.delete(reverse('arm-detail', args=(self.arm1.id,))).status_code)
        self.assertEqual(204, self.client.delete(reverse('studyitem-detail', args=(self.study_item1.id,))).status_code)
        self.assertEqual(204, self.client.delete(reverse('study-detail', args=(self.study1.id, ))).status_code)
