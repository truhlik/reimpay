...
class CraListTestCase(BaseViewPermissionTestCase):

    def setUp(self) -> None:
        super(CraListTestCase, self).setUp()
    ...
    def test_list_draft(self):
        ...
        self.assertEqual(403, self.client.get(reverse('studyitem-list')).status_code)
