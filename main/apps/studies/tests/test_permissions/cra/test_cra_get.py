...
class CraGetTestCase(BaseViewPermissionTestCase):

    def setUp(self) -> None:
        super(CraGetTestCase, self).setUp()
    ...
    def test_get_draft(self):
        ...
        self.assertEqual(403, self.client.get(reverse('studyitem-detail', args=(self.study_item1.id,))).status_code)
